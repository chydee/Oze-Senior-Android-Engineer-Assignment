...
import com.chidi.ozeseniorandroidengineerassignment.core.constants.AppConstants.DEFAULT_RESULT_LIMIT
...
interface ApiService {
    ...
    fun getGithubUsers(@Query("q") query: String = DEFAULT_QUERY_LOCATION, @Query("page") page: Int, @Query("per_page") limit: Int = DEFAULT_RESULT_LIMIT): Single<UsersModel>
